...
const skills: Skill[] = [
  {
    ...
    emoji: "🏗️",
    color: "#6c47ff",
    items: ["Market Research", "Brand Strategy", "GTM Strategy", "Product Launches", "Brand Equity", "Consumer Behavior"],
  },
  {
    category: "Digital & Social",
    emoji: "📱",
    color: "#ff6b6b",
    items: ["Social Media Strategy", "Paid Media", "SEO Copywriting", "Community Growth", "Performance Marketing"],
  },
  {
    category: "Meme & Moment Marketing",
    emoji: "🔥",
    color: "#ff9f43",
    items: ["Trend Hijacking", "Real-Time Content", "Cultural Commentary", "Meme Formats", "Newsjacking", "Viral Content Strategy", "Platform-Native Humour"],
  },
  {
    category: "Tools & Platforms",
    emoji: "🛠️",
    color: "#00c49f",
    items: ["Google Ads", "Google Analytics", "Meta Business Suite", "Sprout Social", "Hootsuite", "Canva"],
  },
  {
    category: "Core Craft",
    emoji: "✍️",
    color: "#a29bfe",
    items: ["Agency Management", "Cross-Functional Collaboration", "Project Management", "Data-Driven Decision Making"],
  },
];
...
const caseStudies: CaseStudy[] = [
  {
    ...
    objective:
      "Strengthen brand personality and recall, build repeatable launch frameworks, and use creators to increase trust and reach.",
    insight:
      "Engagement and conversion improved when content felt conversational, culturally relevant, and creator-validated rather than overly polished.",
    strategy: [
      "Built always-on relatable content to humanize the brand",
      "Structured launches into teaser → education → creator amplification → conversion",
      "Integrated creators into storytelling rather than only promotions",
    ],
    execution: [
      "Managed social media end-to-end for mCaffeine",
      "Planned and executed a launch event for Body Scrubs",
      "Contributed to branding for upcoming sub-brands (makeup & fragrance)",
    ],
  ...
  },
  {
    ...
    objective:
      "Launch a new brand with a clear identity, align messaging across all touchpoints, and ensure launch translated into measurable growth.",
    insight:
      "A new brand required stronger credibility signals and consistent storytelling to build trust quickly.",
    strategy: [
      "Built messaging frameworks focused on problem–solution storytelling",
      "Used NYNM's existing audience trust to introduce the new brand",
      "Structured launch content across awareness, education, and conversion",
    ],
    execution: [
      "Contributed to website copy and product storytelling",
      "Worked on packaging messaging and tone alignment",
      "Managed both organic and performance campaigns",
    ],
  ...
  },
  {
    ...
    objective:
      "Improve ad relevance and Quality Score, reduce recurring performance issues, align brand messaging with user intent across 100+ global advertisers.",
    insight:
      "Performance gaps often stemmed from message–intent mismatch rather than targeting or budget issues.",
    strategy: [
      "Refined messaging to match search intent stages",
      "Ensured clarity while preserving brand tone",
      "Used root-cause analysis to address systemic problems",
    ],
    execution: [
      "Reviewed ad copy across large advertiser portfolios",
      "Conducted RCA on recurring campaign issues",
      "Piloted workflow improvements to reduce repetition",
    ],
  ...
  },
  {
    ...
    objective:
      "Clearly communicate product value to schools, align marketing and sales messaging, and support adoption through structured communication.",
    insight: "Decision-makers needed clearer articulation of outcomes rather than features.",
    strategy: [
      "Shifted messaging toward student impact",
      "Ensured website, presentations, and campaigns aligned",
      "Structured communication across awareness and proof stages",
    ],
    execution: [
      "Led website content coordination",
      "Supported messaging frameworks for presentations",
      "Worked cross-functionally with product and sales teams",
    ],
      ...
      >
        <span
          style={{
            ...
            background: "linear-gradient(90deg,#ff6b6b,#6c47ff)",
...
function SectionTitle({ children, sub }: { children: React.ReactNode; sub?: string }) {
  return (
    <div style={{ marginBottom: 52 }}>
      <h2 style={{ fontSize: 38, fontWeight: 900, color: "#fff", margin: 0, letterSpacing: "-1px" }}>
        {children}
      </h2>
      {sub && (
        <p style={{ margin: "10px 0 0", color: "rgba(255,255,255,0.4)", fontSize: 15 }}>{sub}</p>
      )}
      <div
        style={{
          width: 40, height: 3,
...
function CaseStudyChart({ cs }: { cs: CaseStudy }) {
  ...
  if (cs.chartType === "custom") {
    const customMetrics = [
      { label: "Website Traffic", val: "+40%", desc: "via social" },
      { label: "Revenue from Social", val: "25%", desc: "of total revenue" },
      { label: "Google Ads ROAS", val: "22x", desc: "return on spend" },
    ];
    return (
      <div>
        <p
  ...
  return (
    <div
      style={{
        ...
        border: `1px solid ${open ? cs.color + "66" : "rgba(255,255,255,0.07)"}`,
    ...
    >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <span
            style={{
              ...
              background: cs.color + "22", borderRadius: 12,
      ...
      {open && (
        <div style={{ padding: "0 30px 30px", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          <div
            style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, marginTop: 24 }}
          >
            <div>
              {([["Objective", cs.objective], ["Insight", cs.insight]] as [string, string][]).map(
                ([label, text]) => (
              ...
              {([["Strategy", cs.strategy], ["Execution", cs.execution]] as [string, string[]][]).map(
                ([label, arr]) => (
                  <div key={label} style={{ marginBottom: 18 }}>
                    <h4
                      style={{
                    ...
                    <ul style={{ margin: 0, paddingLeft: 16 }}>
                      {arr.map((s, i) => (
                        <li
                          key={i}
                          style={{ fontSize: 14, color: "rgba(255,255,255,0.6)", lineHeight: 1.7, marginBottom: 4 }}
                        >
                          {s}
                        </li>
                      ))}
    ...
    <div style={{ fontFamily: "'Inter', 'Helvetica Neue', sans-serif", background: "#0a0a14", color: "#fff" }}>
      ...
      <div
        style={{
          ...
          background:
            "radial-gradient(ellipse at 20% 50%, #6c47ff22 0%, transparent 60%), radial-gradient(ellipse at 80% 20%, #ff6b6b22 0%, transparent 50%), #0a0a14",
      ...
      >
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto", padding: "80px 24px" }}>
          ...
          >
            <span
              style={{
                width: 7, height: 7, background: "#6c47ff",
                borderRadius: "50%", display: "inline-block",
                boxShadow: "0 0 6px #6c47ff",
              }}
            />
            <span style={{ fontSize: 12, color: "rgba(255,255,255,0.6)", fontWeight: 500 }}>
              Marketing Professional · Meme Whisperer · Moment Maven
            </span>
          </div>
          ...
          <h1
            style={{
              ...
              lineHeight: 1.0, letterSpacing: "-3px", margin: "0 0 24px",
            }}
          >
            <span style={{ color: "#fff" }}>Kriti</span>
            <br />
            <span
              style={{
                background: "linear-gradient(90deg,#ff6b6b,#6c47ff,#00c49f)",
                WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent",
              }}
            >
              Chopra.
          ...
          <div style={{ display: "flex", gap: 16 }}>
            <a
              href="#case-studies"
              style={{
                background: "linear-gradient(135deg,#ff6b6b,#6c47ff)",
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
          <div>
            <p style={{ fontSize: 16, color: "rgba(255,255,255,0.6)", lineHeight: 1.85, margin: "0 0 16px" }}>
              I'm a marketing strategist with experience building brands across beauty, edtech, and global
              digital campaigns. My work sits at the intersection of storytelling, performance, and culture.
            </p>
            <p style={{ fontSize: 16, color: "rgba(255,255,255,0.6)", lineHeight: 1.85, margin: "0 0 16px" }}>
              I have a sharp eye for internet culture — knowing when to ride a trend, when to let it pass,
              and when to <em style={{ color: "#ff6b6b" }}>create</em> the moment instead of chasing it. Meme
              marketing isn't just a tactic for me — it's how I stay close to what audiences actually care
              about.
            </p>
            <p style={{ fontSize: 16, color: "rgba(255,255,255,0.6)", lineHeight: 1.85, margin: 0 }}>
              I'm drawn to roles where I can shape brand direction, lead creative strategy, and design
              marketing systems that scale both perception and revenue.
            </p>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            {(
              [
                ["5+", "Years Experience", "#6c47ff"],
                ["100+", "Global Advertisers", "#ff6b6b"],
                ["22x", "ROAS Achieved", "#00c49f"],
                ["3+", "Industries", "#ffbb28"],
      ...
      <div
        style={{
          background: "linear-gradient(135deg, #ff6b6b18, #6c47ff18)",
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "flex-start", gap: 40, flexWrap: "wrap" }}>
            <div style={{ flex: 1, minWidth: 280 }}>
              <div
                style={{
                  fontSize: 13, fontWeight: 700, color: "#ff9f43",
                  textTransform: "uppercase", letterSpacing: 2, marginBottom: 12,
                }}
              >
                🔥 Signature Skill
              </div>
              <h3 style={{ fontSize: 28, fontWeight: 900, margin: "0 0 16px", lineHeight: 1.2 }}>
                Meme & Moment
                <br />
                Marketing
              </h3>
              <p style={{ fontSize: 15, color: "rgba(255,255,255,0.55)", lineHeight: 1.75, margin: 0 }}>
                Brands that stay culturally relevant don't wait — they{" "}
                <em style={{ color: "#ff9f43" }}>react in real time</em>. I specialise in identifying
                breakout moments (trends, news, memes) and translating them into on-brand content that
                earns reach, sparks conversations, and builds genuine community.
              </p>
            </div>
      ...
      <Section id="case-studies" bg="#0a0a14">
        <SectionTitle sub="Click any card to explore strategy, execution & results">
          Case Studies
        </SectionTitle>
        {caseStudies.map((cs) => (
      ...
      <Section id="skills" bg="#0d0d1a">
            ...
            >
              <h4
                style={{
                  ...
                  color: s.color, textTransform: "uppercase", letterSpacing: 1.5,
                }}
              >
                {s.emoji} {s.category}
              </h4>
        ...
        >
          ...
          >
            ✓ Certified &amp; Volunteered:
          </span>
          {[
            "Digital Marketing Certification",
            "Microsoft Excel Specialist",
            "Social Media – Pet Fed India",
            "Event Marketing – The Jai Singh Show",
          ].map((c) => (
            <span
              key={c}
              style={{
        ...
        <div style={{ position: "relative" }}>
          <div
            style={{
              ...
              background: "linear-gradient(180deg,#6c47ff,#ff6b6b,#00c49f,#ffbb28)",
            }}
          />
            ...
            <div key={i} style={{ display: "flex", gap: 28, marginBottom: 44 }}>
              <div
                style={{
                  ...
                  background: exp.color, marginTop: 5, position: "relative", zIndex: 1,
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: 14, color: exp.color, fontWeight: 600, marginTop: 2 }}>
                      {exp.company}
                    </div>
                  </div>
                  <span
                  ...
                  {exp.points.map((p, j) => (
                    <li
                      ...
                      style={{
                        ...
                        lineHeight: 1.75, marginBottom: 5,
                      }}
                    >
                      {p}
                    </li>
      ...
      <Section id="contact" bg="#0d0d1a">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
          <div>
            <p
              style={{
                fontSize: 16, color: "rgba(255,255,255,0.55)", lineHeight: 1.8, margin: "0 0 32px",
              }}
            >
              Open to opportunities in brand strategy, digital marketing, and creative leadership —
              especially where culture, content, and commerce collide.
            </p>
          ...
          <div
            style={{
              background: "linear-gradient(135deg,#6c47ff22,#ff6b6b22)",
              border: "1px solid rgba(255,255,255,0.08)",
          ...
          >
            ...
            <p
              style={{
                fontSize: 14, color: "rgba(255,255,255,0.45)", lineHeight: 1.7, margin: "0 0 24px",
              }}
            >
              Brand strategy, campaigns, or a full-time role — especially if it involves memes.
            </p>
            <a
              href="mailto:work.kritichopra@gmail.com"
              style={{
      ...
      <div
        style={{
          background: "#060610", padding: "24px", textAlign: "center",
          borderTop: "1px solid rgba(255,255,255,0.05)",
        }}
      >
        <p style={{ margin: 0, color: "rgba(255,255,255,0.2)", fontSize: 13 }}>
          © 2025 Kriti Chopra · Marketing Professional · Built with ♥ and probably a trending audio
        </p>
      </div>
    </div>
  );
